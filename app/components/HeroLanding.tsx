      ...
      <div className="relative z-10 flex flex-col items-center justify-end md:justify-center px-6 md:px-12 lg:px-20 py-12 pb-20 md:py-12 lg:py-0 h-screen pt-20">
        ...
        <div className="w-full max-w-4xl text-center lg:text-left">
          ...
          <p className="text-gray-200 text-base md:text-lg max-w-md mx-auto lg:mx-0 mb-8 leading-relaxed">
            ...
            I am a highly motivated and skilled Front-End Developer with over 3 years of experience building and optimising e-commerce web applications. I have a proven ability to deliver high-quality, user-friendly interfaces and a strong passion for continuous learning and exploring new technologies. I am eager to contribute to a dynamic team and create innovative web solutions.          </p>
          ...
          <a
            href="/MUGILAN_RESUME.pdf"
            download='MUGILAN_RESUME'
